...
![npm](https://img.shields.io/npm/v/ai-e2e-gen)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-e2e-gen)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# End-to-end test generation and automation tool

End-to-end test generator. Creates Cypress or Playwright tests from user stories and requirements.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-e2e-gen.svg)](https://badge.fury.io/js/ai-e2e-gen)
